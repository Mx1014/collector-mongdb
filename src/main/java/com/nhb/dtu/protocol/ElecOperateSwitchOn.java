...
/**
 * 
 * @ClassName: ElecOperateSwitchOn
 * @Description: 智能电操 合闸命令
 * @author XS guo
 * @date 2017年8月25日 上午11:03:39
 * @see [相关类/方法]（可选）
 * @since [产品/模块版本] （可选）
 */
public class ElecOperateSwitchOn extends AbstractDevice {
	...
	public ElecOperateSwitchOn(ReceiptCollector receiptCollector, ReceiptMeter receiptMeter,
