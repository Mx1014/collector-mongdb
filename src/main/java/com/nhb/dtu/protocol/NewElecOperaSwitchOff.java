...
/**
 * 
 * @ClassName: NewElecOperaSwitchOff
 * @Description: 智能电操（新）- 拉闸命令
 * @author XS guo
 * @date 2017年9月1日 下午2:07:07
 * @see [相关类/方法]（可选）
 * @since [产品/模块版本] （可选）
 */
public class NewElecOperaSwitchOff extends AbstractDevice {
	...
	public NewElecOperaSwitchOff(ReceiptCollector receiptCollector, ReceiptMeter receiptMeter,
