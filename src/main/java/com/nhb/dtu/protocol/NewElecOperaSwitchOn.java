...
/**
 * 
 * @ClassName: NewElecOperaSwitchOn
 * @Description: 智能电操（新）-合闸命令
 * @author XS guo
 * @date 2017年9月1日 下午2:07:40
 * @see [相关类/方法]（可选）
 * @since [产品/模块版本] （可选）
 */
public class NewElecOperaSwitchOn extends AbstractDevice {
	...
	public NewElecOperaSwitchOn(ReceiptCollector receiptCollector, ReceiptMeter receiptMeter,
