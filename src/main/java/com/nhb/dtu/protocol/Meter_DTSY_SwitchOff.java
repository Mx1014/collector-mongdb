 ...
 * @Description: 预付费电表拉闸指令
 * @author XS guo
 * @date 2017年8月4日 下午1:38:13
 * @see [相关类/方法]（可选）
 * @since [产品/模块版本] （可选）
 */
public class Meter_DTSY_SwitchOff extends AbstractDevice {
	...
	public Meter_DTSY_SwitchOff(ReceiptCollector receiptCollector, ReceiptMeter receiptMeter,
