...
public class ConfigBean {
	...
	// 是否从数据库读取
	private static Boolean rateFromDataBaseEnabled;
	...
	public static Boolean getRateFromDataBaseEnabled() {
		return rateFromDataBaseEnabled;
	}

	public static void setRateFromDataBaseEnabled(Boolean rateFromDataBaseEnabled) {
		ConfigBean.rateFromDataBaseEnabled = rateFromDataBaseEnabled;
	}
